<div class="container-fluid">
    <div class="top-right-strip row">
        ...
        <div class="overlay-login text-left">
            <button id="btnlogin" type="button" class="overlay-close1">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="displayProducts.php">All Products</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <form class="button-log">
                            <a class="dropdown-item btn-open" href="login.php">
                                Login
                            </a>
                        </form>
                        <form class="button-register">
                            <a class="dropdown-item btn-open2" href="register.php">
                                Register
                            </a>
                        </form>
                    </div>
